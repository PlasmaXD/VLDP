//! Perform a benchmark with a random input of the Expand VLDP scheme, for the parameters given in
//! the files specified in lines 21-29.
//!
...
fn main() {
    ...
    const MT_DEPTH: usize = include!("../parameters/mt_depth");
