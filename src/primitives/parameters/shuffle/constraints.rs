//! R1CS constraint generation and variable allocation for the parameters of the Shuffle VLDP
//! scheme.
...
/// All R1CS variables for the parameters needed for the Shuffle scheme.
pub struct ParametersShuffleVar<Conf: Config, ConfG: ConfigGadget<Conf>> {
...
impl<Conf: Config, ConfG: ConfigGadget<Conf>, const GAMMA_BYTES: usize>
    AllocVar<ParametersShuffle<Conf, GAMMA_BYTES>, ConstraintField<Conf>>
    for ParametersShuffleVar<Conf, ConfG>
{
    fn new_variable<T: Borrow<ParametersShuffle<Conf, GAMMA_BYTES>>>(
